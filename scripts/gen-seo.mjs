...
<!-- Generated by scripts/gen-seo.mjs from site.routes.js. Do not edit. -->
<urlset
...
${ROUTES.map((r) => `- ${abs(r.path)} — ${r.description}`).join('\n')}
...
- Every URL under "Pages" is a separate prerendered document, listed in
  ${abs('/sitemap.xml')}.
